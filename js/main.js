const saveProduct = async(data) => {
    const url = "https://67e686856530dbd311105617.mockapi.io/products"
...
const editProduct = async(data) => {
    ...
    const url = `https://67e686856530dbd311105617.mockapi.io/products/${id}`
    const header = new Headers()
    header.append("Content-Type", "application/json")
    const config = {
        method: "PUT",
...
const saveUser = async(data) => {
    const url = "https://67e686856530dbd311105617.mockapi.io/users"
    const header = new Headers()
    header.append("Content-Type", "application/json")
    const config = {
        method: "POST",
...
const editUser = async(data) => {
    const { id, ...dataUpdate } = data
    const url = `https://67e686856530dbd311105617.mockapi.io/users/${id}`
    const header = new Headers()
    header.append("Content-Type", "application/json")
    const config = {
        method: "PUT",
